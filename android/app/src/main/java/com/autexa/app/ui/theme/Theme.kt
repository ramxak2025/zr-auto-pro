...
fun AutexaTheme(
    ...
    MaterialTheme(
        ...
        // Make Inter the default for any Text() that doesn't pull a style from
        // MaterialTheme.typography explicitly. Without this every hand-sized
        // Text() would fall back to the system default font.
