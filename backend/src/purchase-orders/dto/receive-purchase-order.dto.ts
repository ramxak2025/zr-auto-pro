...
export class ReceivePurchaseOrderDto {
  ...
  /**
   * Дата поставки: 'YYYY-MM-DD' (календарный день в ПОЯСЕ АВТОСЕРВИСА —
   * tenants.timezone, миграция 157; так шлют веб и мобилка) или полный ISO.
   * Опущено ⇒ момент приёмки.
   */
  @IsOptional()
