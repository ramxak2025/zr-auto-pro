 ...
 * поставки (159).
 *
 * Одно поле — новая дата поставки: 'YYYY-MM-DD' (календарный день в ПОЯСЕ
 * АВТОСЕРВИСА — tenants.timezone, миграция 157; так шлют веб и мобилка) или
 * полный ISO. Сервер переносит на неё ВСЕ записи
