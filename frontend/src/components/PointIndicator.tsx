 ...
 * открытый позже филиал («ТопГаз»). Филиал — свойство сессии (163), и меняется
 * он ТОЛЬКО в разделе «Филиалы»: руководителю — одним нажатием, через
 * перевыпуск сессии (167), сотруднику — выходом и входом. Требование владельца
 * дословно: переключаться только там. Отсюда — никогда.
 *
