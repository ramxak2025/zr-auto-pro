...
const menuItems: MenuItem[] = [
  ...
  {
    // «Филиалы» (156/160/161/163) — сводка по сети: основной сервис владельца
    // и открытые им филиалы с оборотом каждого. Переключения филиала здесь
    // нет: он выбирается при входе, и чтобы уйти в другой, надо выйти и войти
    // заново. В шапке — только индикатор текущего.
    label: 'Филиалы',
