...
export const PERSISTED_KEYS = [
  ...
  // поэтому его безопасно поднимать до первого ответа сервера. Вход в другой
  // филиал = выход и новый вход, а он чистит весь диск целиком (см.
  // clearPersistentCache), поэтому чужой филиал отсюда не поднимется.
  'points',
] as const;
