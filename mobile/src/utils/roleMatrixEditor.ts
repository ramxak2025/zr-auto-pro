...
const CELL_KIND: Record<EditorPermissionKey, 'scope' | 'bool'> = {
  ...
  salary_view: 'scope',
  salary_payouts_manage: 'bool',
  salary_premiums_manage: 'bool',
  motivation_manage: 'bool',
  // Склад
  warehouse_access: 'bool',
  warehouse_manage: 'bool',
  warehouse_delete: 'bool',
  warehouse_analytics_view: 'bool',
  // Поставщики
  ...
  equipment_permanent_delete: 'bool',
  // CRM
  clients_view: 'bool',
  clients_edit: 'bool',
  clients_delete: 'bool',
  ...
  marketing_manage: 'bool',
  calls_view: 'bool',
  calls_listen: 'bool',
  // Управление
  user_management: 'bool',
  employees_approve_profile: 'bool',
  // Настройки
...
export function draftFromMatrix(matrix: RoleMatrix | null | undefined): RoleMatrixDraft {
  ...
  return {
    ...
    bools: {
      ...
      clients_delete: readBool(m.clients?.delete),
      debts_manage: readBool(m.clients?.debts),
      schedule_view: readBool(m.schedule?.view),
      schedule_manage: readBool(m.schedule?.manage),
      bookings_access: readBool(m.bookings?.view),
      salary_payouts_manage: readBool(m.salary?.payouts),
      salary_premiums_manage: readBool(m.salary?.premiums),
      motivation_manage: readBool(m.salary?.motivation),
      ...
      marketing_manage: readBool(m.marketing?.manage),
      calls_view: readBool(m.calls?.view),
      calls_listen: readBool(m.calls?.listen),
      user_management: readBool(m.employees?.manage),
      employees_approve_profile: readBool(m.employees?.approveProfile),
      settings_manage: readBool(m.settings?.manage),
...
export function matrixFromDraft(draft: RoleMatrixDraft): RoleMatrix {
  ...
  return {
    ...
    warehouse: {
      view: b.warehouse_access,
      manage: b.warehouse_manage,
    ...
    salary: {
      view: s.salary_view,
      payouts: b.salary_payouts_manage,
      premiums: b.salary_premiums_manage,
      motivation: b.motivation_manage,
    },
    ...
    marketing: { view: b.marketing_access, manage: b.marketing_manage },
