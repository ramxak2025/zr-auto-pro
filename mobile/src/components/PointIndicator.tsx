 ...
 * открытый позже филиал («ТопГаз»). Филиал — свойство СЕССИИ (163): он лежит в
 * токене и меняется ТОЛЬКО в разделе «Филиалы» — руководителю мгновенным
 * перевыпуском сессии (167), остальным выходом и повторным входом. Требование
 * владельца дословно: «переключаться только там».
 *
 ...
 * просто подпись — и после мгновенного перехода она обязана обновиться тем же
 * кадром, поэтому раздел «Филиалы» кладёт новый филиал в кеш ['points'] сразу
 * после перевыпуска, не дожидаясь ответа сети.
 *
 * ВАРИАНТЫ:
