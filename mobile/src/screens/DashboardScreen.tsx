...
/**
 * PointIndicatorChip — индикатор автосервиса ТЕКУЩЕЙ СЕССИИ в шапке главной.
 *
 * Подпись, а не кнопка (163): цифры главной принадлежат конкретному
 * автосервису, и владелец обязан видеть, чьи они, — но филиал выбирается один
 * раз, при входе, и внутри приложения не меняется. Вся логика живёт в общем
 * компоненте `components/PointIndicator` — тот же чип стоит в Журнале, на
 * кассовой смене и в расписании, а на Кассе он же в широком варианте.
 */
