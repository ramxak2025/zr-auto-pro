 ...
 *
 * Список ролей тенанта: секция «Системные» (read-only сеяные «Мастер» /
 * «Администратор» / «Директор») и секция «Мои роли» (кастомные). Карточка —
 ...
 *     остальных 403;
 *   • системная роль → RoleEditor в read-only с кнопкой «Создать копию»;
        ...
        {!hasAny && isLoading ? (
          ...
          <>
            ...
            <Text style={[styles.sectionHint, { color: palette.text.tertiary }]}>
              Готовые базовые роли. Их нельзя изменить — откройте и создайте свою копию.
            </Text>
            <View
